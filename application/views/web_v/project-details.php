                        ...
                        <div id="clSix" class="panel-collapse collapse">
                            <div class="block-body">
                                <div class="map-container">
                                    <?=urldecode($one_project->location_map)?>
                    ...
                    <div class="property_block_wrap style-2">
                        ...
                        <div class="property_block_wrap_header">
                            <a data-bs-toggle="collapse" data-parent="#clSev" data-bs-target="#clSev"
                               aria-controls="clOne"
                               href="javascript:void(0);" aria-expanded="true" class="collapsed"><h4
                                        class="property_block_title">Gallery</h4></a>
                        </div>
                        ...
                        <ul>
                            <li>
                                <div class="project-contact">
                                    <h3>Address</h3>
                                    <h5>Marina Arcade Tower - Al Naseem St - Dubai Marina - Dubai.</h5>
                                </div>
                            </li>
                            <li>
                                <div class="project-contact">
                                    <h3>Email Address</h3>
                                    <h5>Sales@madain.ae <br>
                                        Info@madain.ae</h5>
                                </div>
                            </li>
                            <li>
                                <div class="project-contact">
                                    <h3>Phone Number</h3>
                                    <h5>+971 56 477 7666 <br> 042481444</h5>
                                </div>
                            </li>
                        </ul>
                    </div>
