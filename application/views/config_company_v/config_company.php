...
<!--                <div class="form-group">
                ...
                <div class="col-md-6">
                <div class="form-group">
                    <label><!--العنوان بالعربي--><?=translate('Address in Arabic')?></label>
                     <input type="text" name="address" placeholder="<?=translate('Address in Arabic')?>" value="<?php echo $site->address ?>"  class="form-control">
                </div>
                </div>
                <div class="col-md-6">
                <div class="form-group">
                    <label><!--العنوان بالانجليزي--><?=translate('Address in English')?></label>
                     <input type="text" name="address_en" placeholder="<?=translate('Address in English')?>" value="<?php echo $site->address_en ?>"  class="form-control">
                </div>
                </div>
                <div class="col-md-6">
                <div class="form-group">
                    <label><!--العنوان بالانجليزي--><?=translate('Address in Russian')?></label>
                     <input type="text" name="address_ru" placeholder="<?=translate('Address in Russian')?>" value="<?php echo $site->address_ru ?>"  class="form-control">
                </div>
                </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                <h3><?=translate('The Main Data')?>:</h3><hr>
                <div class="form-group">
                    <label><?=translate('Company name in Arabic ')?><!--  إسم الشركة بالعربي--></label>
                    <input type="text" name="nameweb" placeholder="<?=translate('Company name in Arabic ')?>" value="<?php echo $site->nameweb ?>" required class="form-control">
                </div>
                <div class="form-group">
                    <label><?=translate('Company name in English ')?>  <!--إسم الشركة بالانجليزي--></label>
                    <input type="text" name="nameweb_en" placeholder="<?=translate('Company name in English ')?>" value="<?php echo $site->nameweb_en ?>" required class="form-control">
                </div>
                <div class="form-group">
                    <label><?=translate('Company name in Russian ')?>  <!--إسم الشركة بالانجليزي--></label>
                    <input type="text" name="nameweb_ru" placeholder="<?=translate('Company name in Russian ')?>" value="<?php echo $site->nameweb_ru ?>" required class="form-control">
                </div>
                <!--<div class="form-group">
                ...
                <div class="form-group">
                    <label><?=translate('Application name')?> - <?=translate('abbreviation name')?></label>
                    <input type="text" name="abbreviation_name" placeholder="<?=translate('Application name')?> - <?=translate('abbreviation name')?>" value="<?php echo $site->abbreviation_name ?>" required class="form-control">
                </div>
                ...
                <div class="form-group">
                    <label><?=translate('Website Link')?><!--لينك الموقع الإلكتروني--></label>
                    <input type="url" name="website" placeholder="<?=translate('Website Link')?>" value="<?php echo $site->website ?>" class="form-control">
                </div>

                <div class="form-group">
                    <label><?=translate('The official email')?><!--الإيميل الرسمي--> </label>
...
.nopos {
    ...
    margin-top: -39px;
                ...
                <div class="form-group">
                    <label><?=translate('Mobile number')?><!--رقم الجوال--></label>
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                    <label><?=translate('Another mobile number')?><!--رقم جوال أخر--></label>
                    <input type="text" name="hp" placeholder="971-000000" value="<?php echo $site->hp ?>" class="form-control">
               <label class="nopos">971+</label>
                </div>

                <h3><?=translate('Social media data')?><!--بيانات السوشيال ميديا--></h3><hr>
            ...
            <div class="col-md-6">
                ...
                <h3><?=translate('Google Map')?><!--Google Map--></h3><hr>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label><?=translate('application image') ?> - <?=translate('Logo')?><!--صورة التطبيق--> </label>
                ...
                <div class="form-group">
                    <label><?=translate('About Company image')?><!--صورة عن الشركة--> </label>
                            ...
                            <div class="modal-dialog modal-xl" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title" id="myModalLabel"><?=translate('the image')?></h4>
                ...
                <div class="form-group">
                    <label><?=translate('Company profile')?><!--ملف الشركة-->  </label>
                ...
                <div class="form-group map">
                    ...
                    <div class="form-group btn-group">
                        <input type="submit" name="submit" value="<?=translate('Save Data')?>" class="btn btn-success btn-sm">
