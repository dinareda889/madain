            ...
            <div class="card-header">
                ...
                <div class="float-right">
                    <a href="<?=site_url('Jobs_c/add_jobs')?>" class="btn btn-primary btn-flat">
                        ...
                        <?=translate('Employment management')?> </a>
                </div>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <table id="table1" class="table table-bordered table-striped">
                    ...
                    <tr>
                        ...
                        <th class="text-center"><?=translate('The Date')?></th>
                        <th class="text-center"><?=translate('Job title in Arabic')?></th>
                        <th class="text-center"><?=translate('Job title in English')?></th>
                        <th class="text-center"><?=translate('Job title in Russian')?></th>
