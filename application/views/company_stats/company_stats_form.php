...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="card card-primary card-outline">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <?php echo form_open_multipart('Company_stats_c/add_company_stats',array("id"=>'form_div')); ?>
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" name="company_clients" id="company_clients"  value="<?= set_value('company_clients') ?>"  />
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" name="company_services" id="company_services"  value="<?= set_value('company_services') ?>"  />
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" name="company_projects" id="company_projects"  value="<?= set_value('company_projects') ?>"  />
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" name="company_projects_done" id="company_projects_done"  value="<?= set_value('company_projects_done') ?>"  />
