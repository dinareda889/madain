    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title"> <!--تعديل بيانات مستخدم--> <?= translate('Update User Data') ?></h3>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label><?= translate('The Name') ?></label>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label><!--إسم المستخدم--> <?=translate('User Name')?></label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="fas fa-user-alt"></i></span>
                                </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label> <?=translate('The Email')?><!--الإيميل--></label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="fas fa-user-alt"></i></span>
                                </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label> <!--كلمة المرور--> <?=translate('The Password')?></label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="fas fa-user-alt"></i></span>
                                </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label> <?=translate('Confirm Password')?>  <!--تأكيد كلمة المرور --></label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="fas fa-user-alt"></i></span>
                                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group has-danger ">
                            <label><!--الصورة--> <?=translate('The Image')?> *</label>
